  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        button: ["var(--font-outfit)", "Outfit", "sans-serif"],
        navigation: ["var(--font-outfit)", "Outfit", "sans-serif"],
        form: ["var(--font-outfit)", "Outfit", "sans-serif"],
        logo: ["var(--font-outfit)", "Outfit", "sans-serif"],
        label: ["var(--font-outfit)", "Outfit", "sans-serif"],
        outfit: ["var(--font-outfit)", "Outfit", "sans-serif"],
      },
      fontSize: {
        hero: ["48px", { lineHeight: "1.1", letterSpacing: "0" }],
        "hero-md": ["36px", { lineHeight: "1.15", letterSpacing: "0" }],
      },
      borderRadius: {
        card: "24px",
        pill: "999px",
