...
export default async function PublicationDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="container-tour max-w-3xl py-20">
      ...
      <div className="mt-10 rounded-card bg-white p-8"><h2 className="font-heading text-lg font-bold text-navy">Abstract</h2><p className="mt-3 leading-relaxed text-navy/65">{publication.abstract}</p></div>
